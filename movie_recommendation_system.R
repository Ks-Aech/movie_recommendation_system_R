...
## Retrieving the data 
setwd("C:\\Khalid\\Projects\\movie recommendation sytem")
...
image(model_info$sim[1:top_items, 1:top_items],
      main="Heatmap of first rows and columns")
...
top_recommendations <- 10 # the numebr of items to recommend each user 
...
recommendation_matrix <- sapply(predicted_recommendations@items,
                                function(x) {as.integer(colnames(movie_ratings)[x])}) # matrix with recommendations with user 
